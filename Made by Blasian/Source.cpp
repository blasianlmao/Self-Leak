...
namespace Spoofer_menu_test
{
    class Print
    {
        ...
        public static void CleanValorant()
        {
        ...
        public static void CleanValorant2()
        {
        ...
        static public void ValorantClean()
        {
            Thread.Sleep(1000);
            Console.Clear();
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (menu == "1")
            {
                ...
                web.DownloadFile("https://cdn.discordapp.com/attachments/1053795294707449958/1066467752379940974/9N173Z8N324.sys", sys);
                web.DownloadFile("https://cdn.discordapp.com/attachments/1053795294707449958/1066468010577121320/KDM.exe", map);
